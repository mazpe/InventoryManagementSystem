<?
	...
	if(!isset($_SESSION['username']))
		header("location: /login.php?return_url=spacings/spacings.php");
?>
...
<head>
	...
	<script type="text/javascript" src="js/spacings.js"></script>
	<script type="text/javascript" src="js/spacings-detail.js"></script>
</head>
<body>
	<div id="north">
		<?
	...
	<div id="new-blocks" class="x-hidden">
	    <div class="x-window-header">Spacings</div>
	</div>
</body>
</html>