<?
	...
	if(!isset($_SESSION['username']))
		header("location: /login.php?return_url=pots/pots.php");
?>
...
<head>
	...
	<script type="text/javascript" src="js/pots.js"></script>
	<script type="text/javascript" src="js/pots-detail.js"></script>
</head>
<body>
	<div id="north">
		<?
  	...
  	<div id="center"></div>
	<div id='pots-table'></div>
	<form id='general-form'> </form>
	<div id="new-pots" class="x-hidden">
	    <div class="x-window-header">Pots</div>
	</div>
