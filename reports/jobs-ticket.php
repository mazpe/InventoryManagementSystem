<?
	...
	if(!isset($_SESSION['username']))
		header("location: /login.php?return_url=jobs-pending/jobs-pending.php");
?>
...
<head>
	...
	<script>
		var ticketId = <? if(isset($_GET['ticket'])) echo $_GET['ticket']; else echo "0"; ?>;
		var ticketStatus = '<? if($_GET['ticket'])
								{
									$query = "SELECT status FROM ticket WHERE id = ".$_GET['ticket'];
	...
	<script type="text/javascript" src="js/jobs-ticket.js"></script>	
</head>
<body>
	<div id="north">
		<?
