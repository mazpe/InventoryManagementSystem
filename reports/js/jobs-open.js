...
Ext.onReady(function() 
{
	...
	{
		//TODO 		
		proxy: new Ext.data.HttpProxy({url:'php/plant_data.php?status=Open', method:'post'}),
		reader: new Ext.data.JsonReader(
		{
            root: 'data',
            totalProperty: 'totalCount',
	...
	var date = new Ext.form.ComboBox(
	{
		...
		{
    		fields: ['date', 'date_id'],
			data : [['All','0'],['Past Due','1'],['This Week','2'],['This Year','3'],['Month to Date','4'],['Year to Date','5']]
		}),*/
		store: dsDate,
        valueField:'label',
        displayField:'label',
