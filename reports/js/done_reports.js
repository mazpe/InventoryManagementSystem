...
Ext.onReady(function() 
{
	...
	{
		//TODO 		
		proxy: new Ext.data.HttpProxy({url:'php/done_reports_data.php?status=Completed&completed=1', method:'post'}),
		reader: new Ext.data.JsonReader(
		{
            root: 'data',
            totalProperty: 'totalCount',
