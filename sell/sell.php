<?
	...
	if(!isset($_SESSION['username']))
		header("location: /login.php?return_url=blocks/blocks.php");
?>		
...
<head>
	...
	<!--script type="text/javascript" src="js/sell-detail.js"></script-->
</head>
<body>
	<div id="north">
		<?
	...
	<div id="new-sell" class="x-hidden">
	    <div class="x-window-header">Sell</div>
	</div>	
</body>
</html>