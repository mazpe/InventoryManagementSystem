<?
	...
	if(!isset($_SESSION['username']))
		header("location: /login.php?return_url=employees/employees.php");
?>		
...
<head>
	...
	<script type="text/javascript" src="js/employees-detail.js"></script>
</head>
<body>
	<div id="north">
		<?
	...
	<div id="new-blocks" class="x-hidden">
	    <div class="x-window-header">Employees</div>
	</div>
</body>
</html>