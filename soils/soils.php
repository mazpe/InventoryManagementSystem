<?
	...
	if(!isset($_SESSION['username']))
		header("location: /login.php?return_url=soils/soils.php");
?>
...
<head>
	...
	<script type="text/javascript" src="js/soils.js"></script>
	<script type="text/javascript" src="js/soils-detail.js"></script>
</head>
<body>
	<div id="north">
		<?
	...
	<div id="new-soils" class="x-hidden">
	    <div class="x-window-header">Soil</div>
	</div>
</body>
</html>