<?
	...
	if(!isset($_SESSION['username']))
		header("location: /login.php?return_url=fertilizers/fertilizers.php");
?>		
...
<head>
	...
	<script type="text/javascript" src="js/fertilizers.js"></script>
	<script type="text/javascript" src="js/fertilizer-detail.js"></script>
</head>
<body>
	<div id="north">
		<?
	...
	<div id="new-blocks" class="x-hidden">
	    <div class="x-window-header">Fertilizers</div>
	</div>
</body>
</html>