<?
	...
	if(!isset($_SESSION['username']))
		header("location: /login.php?return_url=herbicides/herbicides.php");
?>	
...
<head>
	...
	<script type="text/javascript" src="js/herbicides.js"></script>
	<script type="text/javascript" src="js/herbicide-detail.js"></script>
</head>
<body>
	<div id="north">
		<?
	...
	<div id="new-blocks" class="x-hidden">
	    <div class="x-window-header">Herbicides</div>
	</div>
</body>
</html>