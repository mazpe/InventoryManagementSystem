<?
	...
	if(!isset($_SESSION['username']))
		header("location: /login.php?return_url=sources/sources.php");
?>
...
<head>
	...
	<script type="text/javascript" src="js/sources-detail.js"></script>
</head>
<body>
	<div id="north">
		<?
	...
	<div id="new-blocks" class="x-hidden">
	    <div class="x-window-header">Sources</div>
	</div>
</body>
</html>