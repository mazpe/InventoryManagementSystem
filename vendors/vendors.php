<?
	...
	if(!isset($_SESSION['username']))
		header("location: /login.php?return_url=vendors/vendors.php");
?>
...
<head>
	...
	<script type="text/javascript" src="js/vendors-detail.js"></script>
</head>
<body>
	<div id="north">
		<?
	...
	<div id="new-blocks" class="x-hidden">
	    <div class="x-window-header">Vendors</div>
	</div>
</body>
</html>