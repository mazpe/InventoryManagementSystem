<?
	...
	if(!isset($_SESSION['username']))
		header("location: /login.php?return_url=templates/templates.php");
?>
...
<head>
	...
	<script type="text/javascript" src="js/templates-detail.js"></script>
</head>
<body>
	<div id="north">
		<?
	...
	<div id="new-blocks" class="x-hidden">
	    <div class="x-window-header">Labor</div>
	</div>
</body>
</html>